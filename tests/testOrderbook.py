...
class TestOrderbook(unittest.TestCase):
    ...
    def test_add_order_to_history(self):
        ...
        '''
        h1 = {'order_id': 5, 'trader_id': 1001, 'timestamp': 4, 'type': OType.ADD, 'quantity': 5,
              'side': Side.ASK, 'price': 55}
        h1v = {'order_id': 5, 'trader_id': 1001, 'timestamp': 4, 'type': OType.ADD.value, 'quantity': 5,
              'side': Side.ASK.value, 'price': 55}
        self.assertFalse(self.ex1.order_history)
        self.ex1.add_order_to_history(h1)
        h1v['exid'] = 1
        self.assertDictEqual(h1v, self.ex1.order_history[0])
    ...
    def test_remove_order(self):
        ...
        # remove first order
        self.ex1._remove_order(Side.BID, 50, 1)
        self.assertEqual(self.ex1._bid_book[50]['num_orders'], 1)
        self.assertEqual(self.ex1._bid_book[50]['size'], 1)
        ...
        # remove second order
        self.ex1._remove_order(Side.BID, 50, 2)
        self.assertFalse(self.ex1._bid_book_prices)
        ...
        # remove first order
        self.ex1._remove_order(Side.ASK, 52, 3)
        self.assertEqual(self.ex1._ask_book[52]['num_orders'], 1)
        self.assertEqual(self.ex1._ask_book[52]['size'], 1)
        ...
        # remove second order
        self.ex1._remove_order(Side.ASK, 52, 4)
        self.assertFalse(self.ex1._ask_book_prices)
    ...
    def test_modify_order(self):
        ...
        self.assertEqual(self.ex1._bid_book[50]['size'], 2)
        # remove 1
        self.ex1._modify_order(Side.BID, 1, 1, 50)
        self.assertEqual(self.ex1._bid_book[50]['size'], 1)
        ...
        # remove 1
        self.ex1._modify_order(Side.ASK, 1, 2, 50)
    ...
    def test_add_trade_to_book(self):
        ...
        t1 = dict(resting_trader_id=1001, resting_order_id=1, resting_timestamp=2,
                  ...
                  quantity=1, side=Side.BID.value)
        self.assertFalse(self.ex1.trade_book)
        self.ex1._add_trade_to_book(1001, 1, 2, 2001, 1, 5, 50, 1, Side.BID)
    ...
    def test_process_order(self):
        ...
        q3_sell = {'order_id': 1, 'trader_id': 2003, 'timestamp': 5, 'type': OType.ADD, 'quantity': 1, 
                   'side': Side.ASK, 'price': 0}
        ...
        q3_buy = {'order_id': 2, 'trader_id': 2003, 'timestamp': 5, 'type': OType.ADD, 'quantity': 1,
                  'side': Side.BID, 'price': 10000}
        ...
        q4_buy = {'order_id': 1, 'trader_id': 1004, 'timestamp': 10, 'type': OType.ADD, 'quantity': 1,
                  'side': Side.BID, 'price': 48}
        ...
        q4_cancel1 = {'order_id': 1, 'trader_id': 1004, 'timestamp': 10, 'type': OType.CANCEL, 'quantity': 1,
                      'side': Side.BID, 'price': 48}
        ...
        q4_sell = {'order_id': 2, 'trader_id': 1004, 'timestamp': 10, 'type': OType.ADD, 'quantity': 1,
                   'side': Side.ASK, 'price': 54}
        ...
        self.assertFalse(self.ex1.traded)
        self.assertEqual(len(self.ex1._lookup[1004]), 1)
        q4_cancel2 = {'order_id': 2, 'trader_id': 1004, 'timestamp': 10, 'type': OType.CANCEL, 'quantity': 1,
                      'side': Side.ASK, 'price': 54}
        ...
        q5_buy = {'order_id': 1, 'trader_id': 1005, 'timestamp': 10, 'type': OType.ADD, 'quantity': 5,
                  'side': Side.BID, 'price': 48}
        ...
        q5_modify1 = {'order_id': 1, 'trader_id': 1005, 'timestamp': 10, 'type': OType.MODIFY, 'quantity': 2,
                      'side': Side.BID, 'price': 48}
        ...
        q5_sell = {'order_id': 2, 'trader_id': 1005, 'timestamp': 10, 'type': OType.ADD, 'quantity': 5, 
                   'side': Side.ASK, 'price': 54}
        ...
        q5_modify2 = {'order_id': 2, 'trader_id': 1005, 'timestamp': 10, 'type': OType.MODIFY, 'quantity': 2,
                      'side': Side.ASK, 'price': 54}
    ...
    def test_match_trade_sell(self):
        ...
        q1 = {'order_id': 1, 'trader_id': 1100, 'timestamp': 10, 'type': OType.ADD, 'quantity': 1,
              'side': Side.ASK, 'price': 0}
        ...
        q2 = {'order_id': 2, 'trader_id': 1100, 'timestamp': 11, 'type': OType.ADD, 'quantity': 4,
              'side': Side.ASK, 'price': 0}
        ...
        # make new market
        q3 = {'order_id': 27, 'trader_id': 1101, 'timestamp': 12, 'type': OType.ADD, 'quantity': 2,
              'side': Side.BID, 'price': 48}
        q4 = {'order_id': 28, 'trader_id': 1101, 'timestamp': 13, 'type': OType.ADD, 'quantity': 3,
              'side': Side.ASK, 'price': 48}
    ...
    def test_match_trade_buy(self):
        ...
        # make new market
        q3 = {'order_id': 17, 'trader_id': 1101, 'timestamp': 12, 'type': OType.ADD, 'quantity': 2,
              'side': Side.ASK, 'price': 54}
        q4 = {'order_id': 18, 'trader_id': 1101, 'timestamp': 13, 'type': OType.ADD, 'quantity': 3,
               'side': Side.BID, 'price': 54}
        self.ex1.process_order(q3)
        self.assertEqual(len(self.ex1._ask_book_prices), 2)
        self.assertTrue(55 in self.ex1._ask_book_prices)
    ...
    def test_market_collapse(self):
        ...
        q1 = {'order_id': 1, 'trader_id': 1100, 'timestamp': 10, 'type': OType.ADD, 'quantity': 4,
              'side': Side.BID, 'price': 100000}
        self.ex1.process_order(q1)
        # next market buy order takes out the asks: market collapse
        q2 = {'order_id': 2, 'trader_id': 1100, 'timestamp': 10, 'type': OType.ADD, 'quantity': 5,
              'side': Side.BID, 'price': 100000}
        self.ex1.process_order(q2)
        # market sell order takes out part of the bids: no collapse
        q3 = {'order_id': 3, 'trader_id': 1100, 'timestamp': 10, 'type': OType.ADD, 'quantity': 4,
              'side': Side.ASK, 'price': 0}
        self.ex1.process_order(q3)
        # next market sell order takes out the asks: market collapse
        q4 = {'order_id': 4, 'trader_id': 1100, 'timestamp': 10, 'type': OType.ADD, 'quantity': 5,
              'side': Side.ASK, 'price': 0}
        self.ex1.process_order(q4)
